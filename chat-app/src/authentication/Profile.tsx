...
const Profile = () => {
  ...
  return (
    isAuthenticated && user ? (
      <div className="flex flex-col items-center gap-4 border-2 shadow-2xl p-8 rounded-lg max-w-sm">
        <img 
          ...
          alt={user.name || 'User'} 
          className="w-[110px] h-[110px] rounded-full object-cover border-4 border-blue-400"
          onError={(e) => {
